      ...
      const reservationLine = reservation.reservationLines.map(
        (line: ReservationLine) => {
          return {
            ...
            slip: reservation.paymentSlip?.slipUrl,
            slipStatus: reservation.paymentSlip?.isApproved ? 'approved' : 'pending',
            slipRejectedReason: reservation.paymentSlip?.rejectedReason,
            slipApprovedBy: reservation.paymentSlip?.approveBy,
            slipUpdatedAt: reservation.paymentSlip?.updatedAt,
            price: line.price,
